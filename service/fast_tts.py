...
def print_w_stream(question,answer,user_answer):
    completion = client.chat.completions.create(
        model='gpt-3.5-turbo',
        messages=[
            {"role": "system",
             "content": "你是一个人情练达，能说会到的秘书，你将根据问题以及正确答案，来判断我的回答和给定的答案是否相同，以及有哪些内容需要补充。回答的语气要幽默风趣，调皮可爱用中文回复。"},
...
def chatmultthread_voice(question,answer,user_answer):
    ...
    print_w_stream(question,answer,user_answer)
